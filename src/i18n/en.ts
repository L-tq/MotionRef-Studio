...
export const en: Record<string, string> = {
  ...
  "settings.testOk": "Connection OK — model list received.",
  "settings.testFailNoModels": "Endpoint reachable, but no models returned. Check the model name.",
  "settings.testFail": "Connection failed: {msg}",
