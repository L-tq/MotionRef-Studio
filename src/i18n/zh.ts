...
export const zh: Record<string, string> = {
  ...
  "outliner.parentedIn": "父级为 {name}（位于其他集合）",
  ...
  "inspector.name": "名称",
  "inspector.parent": "父级",
  "inspector.parentNone": "— 无（场景根）",
  "inspector.parentHint": "将对象设为另一个对象的子级（保持世界位置）。子对象的位姿与关键帧变为相对父级的局部值；也可在大纲中拖拽行来设置父级。",
  "inspector.localPoseHint": "局部（相对父级）",
  "inspector.constraints": "约束",
  "inspector.noConstraints": "暂无约束 —— 跟踪、沿路径、子级等约束栈每帧驱动运动（智能体可完整编排）。",
  "inspector.addConstraint": "+ 添加约束…",
  "inspector.constraintEnabled": "启用 / 停用约束",
  "inspector.constraintKeys": "{n} 个关键帧（influence / u）",
  "inspector.ct.track_to": "跟踪 (Track To)",
  "inspector.ct.follow_path": "沿路径 (Follow Path)",
  "inspector.ct.child_of": "子级 (Child Of)",
  "inspector.ct.limit_location": "限制位置",
  "inspector.ct.limit_rotation": "限制旋转",
  "inspector.ct.limit_scale": "限制缩放",
  "inspector.ct.copy_location": "复制位置",
  "inspector.ct.copy_rotation": "复制旋转",
  "inspector.ct.copy_scale": "复制缩放",
  "inspector.ct.transformation": "变换映射",
  ...
  "chat.mockBadge": "模拟",
  "chat.stopped": "已被用户停止。",
  "chat.retrying": "连接中断，正在重试（第 {n}/{max} 次尝试）…",
